...
if [ -f /boot/firmware/PPPwn/PPPwn_v1.tar ] ; then
sudo tar -xf /boot/firmware/PPPwn/PPPwn_v1.tar -C /boot/firmware/
sudo rm /boot/firmware/PPPwn/PPPwn_v1.tar
fi
