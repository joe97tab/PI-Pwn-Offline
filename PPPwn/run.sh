...
done < <(timeout $TIMEOUT sudo /boot/firmware/PPPwn/$CPPBIN --interface "$INTERFACE" --fw "${STAGEONE//.}" --stage1 "/boot/firmware/PPPwn/stage1_$STAGEONE.bin" --stage2 "/boot/firmware/PPPwn/stage2_$STAGETWO.bin")
