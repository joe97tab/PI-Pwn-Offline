...
`To update :` On PC copy and replace all files from /PPPwn/update/ to /firmware/PPPwn/.
...
`To update this image :` On PC copy and replace all files from /PPPwn/update/ to /firmware/PPPwn/.
